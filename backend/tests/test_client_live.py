"""Live integration tests for magicflowClient with real API.
...
from src.client import magicflowClient, StreamEvent
...
if os.environ.get("CI"):
    ...
    _skip_reason = "No config.yaml found â€?live tests require valid API credentials"
...
def client():
    """Create a real magicflowClient (no mocks)."""
    return magicflowClient(thinking_enabled=False)
...
# ===========================================================================
# Scenario 1: Basic chat â€?model responds coherently
# ===========================================================================
...
# ===========================================================================
# Scenario 2: Streaming â€?events arrive in correct order
# ===========================================================================
...
# ===========================================================================
# Scenario 3: Tool use â€?agent calls a tool and returns result
# ===========================================================================
...
# ===========================================================================
# Scenario 4: Multi-tool chain â€?agent chains tools in sequence
# ===========================================================================
...
class TestLiveFileUpload:
    def test_upload_list_delete(self, client, thread_tmp):
        """Upload â†?list â†?delete â†?verify deletion."""
...
# ===========================================================================
# Scenario 6: Configuration query â€?real config loading
# ===========================================================================
...
class TestLiveArtifact:
    def test_get_artifact_after_write(self, client):
        """Agent writes a file â†?client reads it back via get_artifact()."""
        import uuid
